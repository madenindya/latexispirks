...
\noindent Dari kalimat di atas \textit{pattern} unik yang dihasilkan yaitu `<hyponym> adalah <hypernym>'. Lebih detil tahapan pembentukan \textit{pattern} dapat dilihat pada bab 4.4.
...
\begin{equation}
akurasi\,\,sampel = \frac{jumlah\,\,total\,\,sampel\,\,benar}{jumlah\,\,total\,\,sampel}
\end{equation}
