...
%   Pada kasus ini, hanya ingin dilihat kata-kata yang berada diantara kata yang merupakan hipernim-hiponim atau \textit{hyponym-hypernym}. Kata-kata diantara dua relasi dapat dianggap paling dekat jika ingin mencari \textit{memisahkan} setiap relasi tersebut. Pada contoh diatas, \textit{sequence} kata yang dihasilkan adalah '<hyponym>singa<hyponym> adalah <hypernym>kucing<hypernym>'
...
% Tahapan program berbasis Perl program jika diberikan satu kalimat dan satu satu program berikut dalam direktori.
% \begin{enumerate}
...
% Kalimat di atas akan dimasukan ke program \textit{sentence splitter}. Berikut adalah hasil yang diberikan dari proses tersebut. \textit{matching} terhadap korpus Wikipedia dengan 
...
% Model yang berbasis Perl terbentuk, digunakan untuk memberi nilai \textit{similarity} antara kata hipernim-satu program. Hal ini diharapkan dapat memberi informasi lebih dalam direktori mengenai kualitas \textit{memisahkan} setiap
%  yang dihasilkan
%  .
